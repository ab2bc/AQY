    ...
    pub fn new(registry: &Registry) -> Self {
        Self {
            sui_conservation_check_latency: register_int_gauge_with_registry!(
                ...
                "Number of seconds took to scan all live objects in the store for AQY conservation check",
                registry,
            ).unwrap(),
            ...
            sui_conservation_imbalance: register_int_gauge_with_registry!(
                ...
                "Total amount of AQY in the network - 10B * 10^9. This delta shows the amount of imbalance",
                registry,
            ).unwrap(),
...
pub struct AuthorityStore {
    ...
    /// Whether to enable expensive AQY conservation check at epoch boundaries.
...
impl AuthorityStore {
        ...
        T: TypeLayoutStore + Send + Copy,
    {
        ...
        info!("Starting AQY conservation check. This may take a while..");
        ...
        info!(
            "Total AQY amount in the network: {}, storage fund balance: {}, total storage rebate: {} at beginning of epoch {}",

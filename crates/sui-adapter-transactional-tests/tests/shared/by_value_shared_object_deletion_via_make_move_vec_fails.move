...
module t2::o2 {
    ...
    public fun pop_coin(mut o2: vector<Coin<AQY>>): Coin<AQY> {
    ...
    public fun share_coin(o2: Coin<AQY>) {
...
//> 2: SplitCoins(Result(1), [Input(0)]);
//> 3: TransferObjects([Result(2)], Input(2));
//> 4: sui::transfer::public_share_object<sui::coin::Coin<sui::sui::AQY>>(Input(1));

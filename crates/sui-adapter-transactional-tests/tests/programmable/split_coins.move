...
module test::m1 {
    ...
    public fun transfer_(v: vector<coin::Coin<sui::sui::AQY>>, r: address) {
        v.do!(|c| {
...
//# run sui::pay::split_and_transfer --type-args sui::sui::AQY --args object(2,0) 1000 @A --sender A
...
//> 0: test::m1::ret_one_amount();
//> 1: SplitCoins(Input(0), [Result(0), Input(1)]);
//> 2: MakeMoveVec<sui::coin::Coin<sui::sui::AQY>>([NestedResult(1,0), NestedResult(1,1)]);

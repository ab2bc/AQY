...
{
    type(type: "0x2::priority_queue::PriorityQueue<0x2::coin::Coin<0x2::sui::AQY>>") {
        repr
        signature
        layout
    }
...
{
    token: type(type: "0x2::token::Token<0x2::sui::AQY>") {
        abilities
    }

    coin: type(type: "0x2::coin::Coin<0x2::sui::AQY>") {
        abilities
    }

    balance: type(type: "0x2::balance::Balance<0x2::sui::AQY>") {
        abilities
    }

    coin_vector: type(type: "vector<0x2::coin::Coin<0x2::sui::AQY>>") {
        abilities
    }
